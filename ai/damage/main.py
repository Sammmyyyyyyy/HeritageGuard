...
def analyze_image(image: Image.Image, site_id: str):
    ...
    # Calculate score
    damage_score = calculate_damage_score(detections)
...
def calculate_damage_score(detections):
    ...
    confidence_component = highest_confidence * 70
    ...
    score = confidence_component + count_component
